...
/////////////////////////////////////////////
//////////////START EXTRA lines for openh323 printing to work OK>
///////////////////////////
#define fprintf   openh323_fprintf
#define printf    openh323_printf

extern void avcodec_set_print_fn(void (*print_fn)(char *));
extern int openh323_fprintf(FILE * f, const char * s, ...);
extern int openh323_printf(const char * s, ...);

/////////////////////////////////////////////
//////////////END EXTRA lines for openh323 printing to work OK>
///////////////////////////
...
#endif //!ALT_BITSTREAM_WRITER


/* Pointer to the byte currently being written */
static inline uint8_t* pbBufPtr(PutBitContext *s)
{
#ifdef ALT_BITSTREAM_WRITER
	return s->buf + (s->index>>3);
#else
    return s->buf_ptr + ((32 - s->bit_left)>>3);
#endif
}

/* Number of bits remaining in the byte currently being written */
static inline int pbBufEndBit(PutBitContext *s)
{
#ifdef ALT_BITSTREAM_WRITER
	return (- s->index) & 7;
#else
...
/**
 * reads 0-17 bits.
 * Note, the alt bitstream reader can read upto 25 bits, but the libmpeg2 reader can't
 */
