...
#if OPENMCU_VIDEO
        if(member == NULL) {members << "<tr><td>" << s->first << "</td><td colspan='5'>Offline</td></tr>"; continue; }
#else
        if(member == NULL) {members << "<tr><td>" << s->first << "</td><td colspan='4'>Offline</td></tr>"; continue; }
#endif
...
#endif
                    << "<br /><b>In: </b>" << conn->GetAudioReceiveCodecName()
#if OPENMCU_VIDEO
