...
window.l_param_sip_proxy = 'External accounts';
...
<p>\
Service FreeMCU is running and accepting connections.\
</p>\
<p>\
Conference started by connection from some terminal will work in unmanaged mode. All members will see the same pictire. In unmanaged mode FreeMCU automatically change layout depending on number of conference members, in order  from file "layouts.conf". After connecting 100 members other connecting members will not be visible, but will see others.<br />\
...
window.l_name_initial_audio_status                 = 'Initial audio status';
