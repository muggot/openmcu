...
#define CODEC_FLAG_INPUT_PRESERVED 0x0100     /** parent program guarantees that the input is not
                                                  written to for at least s->max_b_frames+1 frames
                                                  (if not set, input will be copied) **/
...
/* /Fx */
#define CODEC_FLAG_RFC2190         0x04000000 ///< use additional RFC2190 headers
#define CODEC_FLAG_RFC2429         0x08000000 ///< use additional RFC2429 headers
...
#define FF_BUFFER_TYPE_SHARED   4 ///< buffer from somewher else, don't dealloc
...
#define FF_ASPECT_EXTENDED 15
    ...
    /* Some RTP payload formats, as H.263's RFC2190, */
    /* require that a payload header be inserted     */
    /* before the actual bitstream (hdr_size>0).     */
