...
window.l_param_receive_sound = 'Аудио кодеки (receive)';
window.l_param_transmit_sound = 'Аудио кодеки (transmit)';
window.l_param_receive_video = 'Видео кодеки (receive)';
window.l_param_transmit_video = 'Видео кодеки (transmit)';
