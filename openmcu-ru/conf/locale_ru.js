...
window.l_info_rooms ='Выберите комнату для управления и нажмите кнопку Select.';
...
Станица <b>Records</b> позволяет просматривать содержимое директории (на сервере),\
