...
window.l_name_bandwidth_from_mcu                   = 'Пропускна здатність від MCU';
window.l_name_bandwidth_to_mcu                     = 'Пропускна здатність до MCU';
...
window.l_name_force_split_video        = 'Управляемый режим';
window.l_name_auto_delete_empty        = 'Автоматическое удаление';
window.l_name_auto_record_not_empty    = 'Автоматическая запись';
...
window.l_name_registered                           = 'Зареєстрований';
window.l_name_connected                            = 'Подключен';
window.l_name_last_ping_response                   = 'Последний отклик';

window.l_name_codec                                = 'Кодек';
window.l_name_audio                                = 'Аудiо';
window.l_name_video                                = 'Вiдео';
window.l_name_audio_receive                        = 'Аудiо (приймання)';
window.l_name_audio_transmit                       = 'Аудiо (відправлення)';
window.l_name_video_receive                        = 'Вiдео (приймання)';
window.l_name_video_transmit                       = 'Вiдео (відправлення)';
window.l_name_video_resolution                     = 'Разрешение вiдео';
